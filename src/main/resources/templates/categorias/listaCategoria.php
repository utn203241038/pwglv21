    ...
    <main role="main">     
      ...
      <div class="container"> 
        ...
        <div class="card">
          ...
          <div class="card-body">
            <a class="btn btn-primary" th:href="@{/categorias/nueva}" role="button"><i class="fas fa-file" aria-hidden="true"></i> Nueva</a>            
            <hr>
              ...
              <tbody>
                <tr th:each="categoria:${categorias}">
                	...
                	<td th:text="${categoria.descripcion}"></td>
                	  <td>                    	
                	<a type="button" class="btn btn-success btn-sm" ><i class="fas fa-file" aria-hidden="true"></i></a>
                	<a tybe="button" class="btn btn-success btn-sm" role="button" title="Editar"><i class="fas fa-pencil-alt" aria-hidden="true"></i></a>
                    <a th:href="@{/categorias/eliminar/{id}(id=${categoria.id})}" onclick="return confirm('�Estas seguro?')" class="btn btn-success btn-sm" role="button" title="Eliminar"><i class="fas fa-trash" aria-hidden="true"></i></a>
                	</td >
                </tr>
                <tr></tr>
