    ...
    <main role="main">
      ...
      <div class="container"> 
        ...
        <div class="row" th:each="vacante:${vacantes}">
          <div class="col-md-3">            
			<img class="rounded mx-auto d-block" th:src="@{/logos/{img}(img=${vacante.imagen})}" alt="Generic placeholder image" width="220" height="220">          </div>
          <div class="col-md-9">
            ...
            <p><a class="btn btn-secondary" th:href="@{/vacantes/detalle(id=${vacante.id})}" role="button">View details &raquo;</a></p>            
          </div>
        </div>  
        <div class="row">
